      ...
      <div>
        ...
        <div className='flex justify-between items-center space-x-4 my-6'>
          ...
          >
            ...
            adipisicing elit. Esse, doloribus?
          </h1>
        ...
        <p id='description' className='text-lg'>
          Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Similique pariatur
          modi corrupti cumque atque, rerum
          quaerat repellendus, quidem alias animi
          voluptates doloremque minus consequatur
          expedita iure quis soluta voluptas at
          quod harum veniam? Quasi, asperiores.
          Esse error officia quae, corrupti sunt
          qui nihil officiis. Fugiat, alias sit?
          Similique, ab minima.
        </p>
      </div>
    </div>
